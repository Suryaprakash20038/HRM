...
}, uploadToCloudinary, validateEmployee, employeeController.createEmployee);
...
}, uploadToCloudinary, validateEmployeeUpdate, employeeController.updateEmployee);

router.delete('/:id', employeeController.deleteEmployee);
router.post('/:id/profile-image', uploadMiddleware.single('profileImage'), employeeController.uploadProfileImage);
router.post('/:id/generate-letter', employeeController.generateLetter);
